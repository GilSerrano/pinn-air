...
def add_training_options(parser):
    ...
    group.add_argument("--weight_decay", default=0.05, type=float, help="Optimizer weight decay.")
    ...
    group.add_argument("--num_steps", default=1000, type=int, help="Training will stop after the specified number of steps.")
