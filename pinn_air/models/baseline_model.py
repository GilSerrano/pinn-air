...
| Description: Definition of the baseline encoder-decoder model without slack variables.
"""
import random
...
from pinn_air.models.loss import position_error, velocity_error, position_error_payload, continuity_last_input_first_output, output_continuity, quaternion_norm, quaternion_error, continuity_last_input_first_output_without_payload, iterative_physics_error_without_payload, iterative_physics_error_no_slack
...
class BaselineModel(nn.Module):
    ...
    def __init__(self, system_state_dim, system_control_dim, num_layers, dropout, device):
        ...
        # Set the physics model depending on the system state dimension
        ...
        self.linear_out3 = nn.Linear(100, self.system_state_dim)
    ...
    def forward(self, x, u, target_y=None, teacher_forcing_ratio=0.0):
        ...
        outputs = torch.zeros(x.shape[0], target_time, self.system_state_dim).to(self.device)
    ...
    def set_loss_params(self, position_error, velocity_error, position_error_payload, continuity_last_input_first_output, output_continuity, quaternion_norm, quaternion_error, physics_error, exponential_decay_real, exponential_decay_physics):
    ...
    def loss_with_payload(self, y_hat, y, x):
        ...
        return self.position_error * position_error(y_hat, y, self.exponential_decay_real) + \
            ...
            self.physics_error * iterative_physics_error_no_slack(y_hat, y, x, self.physics_model, self.exponential_decay_physics), {} 
